...
Returns the energy from the CM_out as a function of the orthogonal matrices `X_vec` of the unit cell, using the Gaussian map.
"""
...
Returns the doping from the CM_out as a function of the orthogonal matrices `X_vec` of the unit cell, using the Gaussian map.
"""
...
orthogonal matrices `X_vec`, using the per-site Gaussian map.
"""
